...
public class RCSUnitTextField: RCSTextField {
    ...
    override public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange,
    ...
    private func setMeasurement(string quantityString: String) {
        ...
        let suffixBeginIdx = quantityString.characters.index(quantityString.endIndex,
                                                             offsetBy: -suffixString.characters.count)
