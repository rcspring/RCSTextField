...
public protocol RCSUnitSegmentedControlDelegate {
    func dataModel()-> [(String,Dimension?)]
    func new(unit:Dimension?,idx:Int,on:RCSUnitSegmentedControl)
}
...
public class RCSUnitSegmentedControl : UISegmentedControl {
    ...
    private var shadowDelegate : RCSUnitSegmentedControlDelegate?
    ...
    func segmentChanged(sender:UISegmentedControl) {
        shadowDelegate?.new(unit: dataModel[sender.selectedSegmentIndex].1, idx:sender.selectedSegmentIndex,on: self)
    }
